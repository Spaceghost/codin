...
for pass in augment_c99 augment_slice_string augment_multi_return augment_defer augment_union augment_import augment_generic augment_generic_asttruth augment_diagnostics; do
